...
$whitelist = $pdo->query("SELECT * FROM whitelist");
...
<head>
	<title><?php echo $site_name; ?> | Whitelisting</title>
...
<body>
	...
	<div class="page-header theme-bg-dark py-5 text-center position-relative">
		...
		<div class="container">
			...
			<div class="page-intro single-col-max mx-auto">Whitelist</div>
		</div>
	</div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="card h-100">
						<div class="card-body">
							<h5 class="card-title text-center py-2">Add User to Whitelisted Document</h5>
							<form action="../actions/functions.php" method="post">
								...
								<div class="row justify-content-center">
									<div class="form-group col-md-6 text-center">
										<button class="btn btn-info" type="submit" name="add_whitelist">Add</button>
									</div>
								</div>
							</form>
						</div>
				...
				<div class="col-md-6">
					<div class="card h-100">
						<div class="card-body">
							<h5 class="card-title text-center py-2">Current Whitelists</h5>
								...
								<table class="table text-center">
									<tbody>
										...
										foreach ($whitelist as $row) {
                                            ...
                                            $getdocument = $pdo->query("SELECT * FROM documents WHERE ID='$documentID'");
                                            foreach($getdocument as $row2)
                                            {
                                                $documentName = $row2['name'];
                                            }
											echo '<tr>
                                                <td class="table-text">' . $row['username'] . '</td>
                                                <td class="table-text">' . $documentName . '</td>
                                                <td><a class="btn btn-danger" onclick="deleteWhitelist(`' . $row['ID'] . '`)">Delete</a></td>
                                                </tr>';
										}
										?>
									</tbody>
